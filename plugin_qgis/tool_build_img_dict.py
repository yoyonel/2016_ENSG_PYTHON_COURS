...
class DictImage(object):
    def __init__(self, id_img, img_dir, tup_qgis_layer_featureid, position):
        """
        ...
        :return:
        """
        self.__dict__ = self._build(id_img, img_dir, tup_qgis_layer_featureid, position)

    # url: http://stackoverflow.com/questions/35282222/in-python-how-do-i-cast-a-class-object-to-a-dict
    def __iter__(self):
        return self.__dict__.iteritems()

    @staticmethod
    def _build(id_img, img_dir, tup_qgis_layer_featureid, position):
        return {
            id_img: {
                'path': img_dir,
    ...
    def qgis(self):
        ...
        :return:
        """
        return self.__dict__['plugin_qgis']
    ...
    def build_img_filename(self, id_img):
        """

        :return:
        """
        return os.path.join(self.__dict__['path'], id_img)
    ...
    for layer in layers_compatibles:
        ...
        for feature in layer.getFeatures():
            ...
            if bc_found_img:
                ...
                dict_imgs.update(
                    DictImage(id_img, dir_path_img, (layer, qgis_feature_id), position)
                )
    return dict_imgs

...
import platform
#
from qgis.core import QgsField, QgsPoint, QGis, QgsMapLayer, \
    QgsSymbolV2, QgsSimpleMarkerSymbolLayerV2, QgsRendererCategoryV2, \
...
def select_feature_on_layer(
        _layer_selected, _featureid_selected,
    ...
    iface.mapCanvas().setSelectionColor(_selection_qcolor)
    # urls:
